...
public class DefaultPauseScene extends Scene implements DoOnGameClose {
    ...
    public void init() {
        ...
        if (this.music5 == null) this.music5 = Raylib.LoadMusicStream("assets/examplegame/music/pause5.wav");
    ...
    public void update() {
        ...
        //this.volume5 = Math.clamp(((float) this.ticks - 12000) / 2000, 0.001f, 0.2f);
